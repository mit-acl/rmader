...
import rospy
from rmader_msgs.msg import WhoPlans
...
class Rmader_Commands:
    ...
    def timerTakeOffCB(self, event):
        ...
        self.takeoff_goal.p.z = min(self.takeoff_goal.p.z+0.00005, alt_taken_off);
...
if __name__ == '__main__':
    rospy.init_node('rmader_commands')  
    startNode()
