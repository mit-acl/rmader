...
bool SolverGurobi::optimize(bool &is_stuck, bool &is_A_star_failed, bool &is_q0_fail)
{
  // reset some stuff
  ...
  bool guess_is_feasible =
      generateAStarGuess(is_stuck, is_A_star_failed, is_q0_fail);  // I obtain q_quess_, n_guess_, d_guess_
