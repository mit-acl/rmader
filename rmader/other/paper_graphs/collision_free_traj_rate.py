...
if __name__ == '__main__':
    ...
    fig = plt.figure()
    ax = fig.add_subplot()
    plt.plot(x, rmader, color='r', linewidth=1.5, marker = 'o', ls='dashdot', label='RMADER')
    plt.plot(x, wo_check_rmader, color='purple', linewidth=1.5, marker = 'o', ls='dotted', label='RMADER w/o check')
    plt.plot(x, oldmader, color='b', linewidth=1.5, marker = 'o', ls='-.', label='MADER')
    plt.plot(x, ego_swarm, color='g', linewidth=1.5, marker = 'o', ls=':', label='EGO-Swarm')
