...
if __name__ == '__main__':
    ...
    # completion time
    fig, ax = plt.subplots()
    ax.plot(x, rmader_ave_tt, color='r', linewidth=1.5, marker = 'o', ls='dashdot', label='RMADER')
    ax.plot(x, wo_check_rmader_ave_tt, color='purple', linewidth=1.5, marker = 'o', ls='dotted', label='RMADER w/o check')
    ax.plot(x, oldmader_ave_tt, color='b', linewidth=1.5, marker = 'o', ls='-.', label='MADER')
    ax.plot(x, ego_swarm_ave_tt, color='g', linewidth=1.5, marker = 'o', ls=':', label='EGO-Swarm')
