...
tmux send-keys -t $SESSION:$w.2 "ssh nuc08@192.168.2.2" C-m
...
if [ "$1" == "pos" ]; then
	...
	tmux send-keys -t $SESSION:$w.5 "roslaunch rmader position_exchange.launch mode:=6 quad:=NX07"  
