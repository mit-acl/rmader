...
tmux send-keys -t $SESSION:$w.2 "ssh nuc9@192.168.23.2" C-m
...
if [ "$1" == "pos" ]; then
	...
	tmux send-keys -t $SESSION:$w.2 "roslaunch rmader position_exchange.launch mode:=3 quad:=NX09 one_time_exchange:="$ONE_TIME_EXCHANGE
	tmux send-keys -t $SESSION:$w.3 "roslaunch rmader position_exchange.launch mode:=4 quad:=NX05 one_time_exchange:="$ONE_TIME_EXCHANGE 
	tmux send-keys -t $SESSION:$w.4 "roslaunch rmader position_exchange.launch mode:=5 quad:=NX07 one_time_exchange:="$ONE_TIME_EXCHANGE 
